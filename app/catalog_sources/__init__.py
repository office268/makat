...
# ‏epc ואחריו aftermarket: הראשון מוציא מהשלדה את המספר המקורי, והשני
# מחפש לפיו. laximo/tecdoc נשארים בקוד כחלופה למי שיש לו מולם חשבון.
#
# למה לא laximo, שהיה כאן קודם: כתובת ברירת המחדל שלו היא השערה שלא
# אומתה, ו-laximo.ru מחזיר עליה 404. כלומר ברירת המחדל הקודמת הפעילה
# שני מקורות שאף אחד מהם לא יכול היה לענות, וכיבתה את היחיד שנבדק
# בפועל מול האתר החי ועובד - epc. מקור שלא ניתן להריץ אינו ברירת מחדל.
