...
(function () {
  ...
  // צעד של 5%: מספיק גס כדי שכל לחיצה תיראה, ומספיק עדין כדי לעצור
  // בדיוק על הגודל הנוח. הזום יורד עד חצי - שם נכנסת טבלה שלמה למסך
  // אחד, וזה בדיוק מה שרוצים כשמסתכלים על הרבה מק"טים בבת אחת.
  const LIMITS = {
    zoom: { min: 0.5, max: 1.8, step: 0.05 },
    font: { min: 0.8, max: 1.8, step: 0.05 },
  };
